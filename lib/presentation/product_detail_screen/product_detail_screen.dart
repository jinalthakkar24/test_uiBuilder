import '../product_detail_screen/widgets/group21_item_widget.dart';
                                            ...
                                            children: [
                                              Obx(() => CarouselSlider.builder(
                                                  ...
                                                  itemBuilder: (context, index,
                                                      realIndex) {
                                                    Group21ItemModel model =
                                                        controller
                                                            .productDetailModelObj
                                                            .value
                                                            .group21ItemList[index];
                                                    return Group21ItemWidget(
                                                        model);
                                                  })),
                                              Align(
                                                                ...
                                                                Padding(
                                                                    ...
                                                                    child: Text(
                                                                        ...
                                                                        textAlign:
                                                                            TextAlign
                                                                                .left,
                                                                        style: AppStyle.textstylepoppinsbold101.copyWith(
                                                                            fontSize:
                                                                                getFontSize(10),
                                                                            letterSpacing: 0.50))),
                                                                Padding(
